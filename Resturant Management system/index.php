            ...
            <div class="row g-0">
                ...
                <div class="col-md-6 bg-dark d-flex align-items-center">
                    <div class="p-5 wow fadeInUp" data-wow-delay="0.2s">
                        ...
                        <form method="POST" action="booking-tabel.php">
                            <div class="row g-3">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating date" id="date3" data-target-input="nearest">
                                        <input name="data_booking" type="text" class="form-control datetimepicker-input" id="datetime" placeholder="Date & Time" data-target="#date3" data-toggle="datetimepicker" />
                                ...
                                <?php if(isset($_SESSION['user_id'])) : ?>
                                    <div class="col-12">
                                        <button  name="submit" type="submit" class="btn btn-primary w-100 py-3" >Book Now</button>
                                    </div>
                                <?php else : ?>
                                    <p>Login To Book Tabel </p>
                                <?php endif; ?>    
                            </div>
                        </form>
                    </div>
